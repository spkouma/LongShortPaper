...
\usepackage{multicol}
%\usepackage{helvet}
%\usepackage[font=helvet, labelfont={helvet,bf}, margin=1cm]{subcaption} %labelfont I put bf as well
...
%surface under dilute aqueous solution conditions 
($10^{-3}$ g/L).  
...
%This  was  done  by  comparing every scenario of surface coverage, using the associated likelihood of its occurrence.  
...
%is combinatorial the standard or is it combinatoric [**SK**]
...
%changed to concat version for consistency [**sk**]
...
lattice in our solution region of volume $V$.
 ...
 \begin{figure}[H] 
  \includegraphics[scale=0.12]{fig7a_may4_2020.pdf}
...
%\label{} is not functioning properly, and it could because of the starred caption (ie; suppress auto-enumeration scheme)
\begin{table}
\begin{center}
\begin{tabular}{|c|c|c|}
    \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{PresentationGraphicFinal.pdf}
