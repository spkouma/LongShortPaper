...
$\left(\frac{|\mathcal{E}_{j+1}|}{|\mathcal{E}_j|}\right)$ as a function of quantity of $\leng_L$-mers (long-chains) adsorbed to the colloid surface. We observe that the ratio of probabilities %approaching one, from functional values 
are all much
