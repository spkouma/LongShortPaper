...
% %removed for reasons detailed below
% \begin{equation}
%     \label{}
...
%jumped straight to the final approximation, as Ozzy asking why we did all of that which would require getting in the technicalities of how the mechanics of this approximation theory 
%%Bring this back!!!!
%since that is (look at paper copy)
